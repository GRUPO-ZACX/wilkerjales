...
import type { NewsletterAttorney } from "yes@/lib/newsletter/types"
  ...
  return (
    <aside className="h-fit border border-[#B7B783] bg-white shadow-[0_14px_35px_rgba(22,59,53,0.08)]">
      ...
      <div className="px-5 py-5">
        <h2 className="text-2xl font-semibold leading-tight tracking-[-0.02em] text-[#1F1F1A] [overflow-wrap:anywhere]">
          {name}
        </h2>
        <p className="mt-2 text-sm font-semibold uppercase tracking-[0.12em] text-[#244F49] [overflow-wrap:anywhere]">
          {specialty}
        </p>
        <div className="mt-5 border-t border-[#B7B783] pt-4">
          <Quote className="size-5 text-[#B7B783]" />
          <p className="mt-3 text-[17px] font-medium leading-7 text-[#163B35] [overflow-wrap:anywhere]">
            {phrase}
          </p>
        </div>
      </div>
